...
Once the application is generated, add the following *RestAssured* and *WireMock* libraries as test dependencies.

[source,groovy,indent=0]
----
include::{codebase}/build.gradle[lines="17..20,27,32..35"]
----
...
https://wiremock.org/[WireMock] is a tool for building mock APIs.
...
We can create an instance of WireMockServer using *WireMockExtension* and
